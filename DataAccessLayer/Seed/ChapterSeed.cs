...
public static class ChapterSeed
{
    ...
    return
        [
            new Chapter { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), ChapterNumber = 1, ChapterTitle = "Introduction to Biology", Description = "Basic concepts of biology.", SubjectId = Guid.Parse("5a5da2f4-f649-4994-95b1-228b82e9d98c"), TermId = Guid.Parse("aa10883b-b521-4c82-8cf5-7dfb4215ebe4") },
